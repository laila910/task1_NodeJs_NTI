...
deleteTask = (taskId) => {
    let tasks = readDataFromJsonFile()
        //the index of the task that I want to delete
        // let index = searchTask(taskId);
        // let remainingTasksAfterDelete = tasks.splice(index, 1);
        // writeDataToJsonFile(remainingTasksAfterDelete);
        // console.log("done remove task with id" + taskId);
    tasks = tasks.filter(t => taskId != t.id);
    writeDataToJsonFile(tasks);
